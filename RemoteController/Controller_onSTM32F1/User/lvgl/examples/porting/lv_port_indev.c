...
void lv_port_indev_init(void)
{
    ...
    indev_drv3.read_cb = keypad_read;
    indev_keypad = lv_indev_drv_register(&indev_drv3);
    ...
    indev_drv4.type = LV_INDEV_TYPE_ENCODER;
    indev_drv4.read_cb = encoder_read;
    indev_encoder = lv_indev_drv_register(&indev_drv4);
    ...
    indev_drv5.read_cb = button_read;
    indev_button = lv_indev_drv_register(&indev_drv5);
...
{
    /*Your code comes here*/
	strType_XPT2046_Coordinate point = {-1, -1, -1, -1};
	XPT2046_Get_TouchedPoint(&point, strXPT2046_TouchPara);
	(*x) = point.x;
	(*y) = point.y;
}
#endif
